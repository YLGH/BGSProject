...
/* CySysClkWriteImoFreq() - implementation definitions */
    ...
    #define CY_SYS_CLK_IMO_TRIM_DELAY_US                (( uint32 )(50u))
        ...
        extern const uint8 cyImoFreqMhz2DPLLIntegral[CY_SYS_CLK_IMO_FREQ_TABLE_SIZE];
        extern const uint8 cyImoFreqMhz2DPLLProportional[CY_SYS_CLK_IMO_FREQ_TABLE_SIZE];
