...
***************************************/
    ...
    #define UART_MOSI_SCL_RX_WAKE_INTCFG_REG    (*(reg32 *) \
                                                              UART_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define UART_MOSI_SCL_RX_WAKE_INTCFG_PTR    ( (reg32 *) \
                                                              UART_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)

    #define UART_INTCFG_TYPE_MASK                  (0x03u)
    #define UART_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS  (UART_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
...
#if(UART_MOSI_SCL_RX_PIN)
    #define UART_MOSI_SCL_RX_HSIOM_REG      (*(reg32 *) UART_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define UART_MOSI_SCL_RX_HSIOM_PTR      ( (reg32 *) UART_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define UART_MOSI_SCL_RX_HSIOM_MASK     (UART_uart_rx_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define UART_MOSI_SCL_RX_HSIOM_POS      (UART_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
#endif /* (UART_MOSI_SCL_RX_PIN) */

#if(UART_MISO_SDA_TX_PIN)
    #define UART_MISO_SDA_TX_HSIOM_REG      (*(reg32 *) UART_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define UART_MISO_SDA_TX_HSIOM_PTR      ( (reg32 *) UART_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define UART_MISO_SDA_TX_HSIOM_MASK     (UART_uart_tx_i2c_sda_spi_miso__0__HSIOM_MASK)
    #define UART_MISO_SDA_TX_HSIOM_POS      (UART_uart_tx_i2c_sda_spi_miso__0__HSIOM_SHIFT)
#endif /* (UART_MISO_SDA_TX_PIN_PIN) */

#if(UART_SCLK_PIN)
    #define UART_SCLK_HSIOM_REG     (*(reg32 *) UART_uart_cts_spi_sclk__0__HSIOM)
    #define UART_SCLK_HSIOM_PTR     ( (reg32 *) UART_uart_cts_spi_sclk__0__HSIOM)
    #define UART_SCLK_HSIOM_MASK    (UART_uart_cts_spi_sclk__0__HSIOM_MASK)
    #define UART_SCLK_HSIOM_POS     (UART_uart_cts_spi_sclk__0__HSIOM_SHIFT)
#endif /* (UART_SCLK_PIN) */

#if(UART_SS0_PIN)
    #define UART_SS0_HSIOM_REG      (*(reg32 *) UART_uart_rts_spi_ss0__0__HSIOM)
    #define UART_SS0_HSIOM_PTR      ( (reg32 *) UART_uart_rts_spi_ss0__0__HSIOM)
    #define UART_SS0_HSIOM_MASK     (UART_uart_rts_spi_ss0__0__HSIOM_MASK)
    #define UART_SS0_HSIOM_POS      (UART_uart_rts_spi_ss0__0__HSIOM_SHIFT)
#endif /* (UART_SS1_PIN) */
