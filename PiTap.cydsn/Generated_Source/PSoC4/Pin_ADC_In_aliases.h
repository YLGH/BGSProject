...
#define Pin_ADC_In_0_PS		(Pin_ADC_In__0__PS)
#define Pin_ADC_In_0_PC		(Pin_ADC_In__0__PC)
#define Pin_ADC_In_0_DR		(Pin_ADC_In__0__DR)
#define Pin_ADC_In_0_SHIFT	(Pin_ADC_In__0__SHIFT)
