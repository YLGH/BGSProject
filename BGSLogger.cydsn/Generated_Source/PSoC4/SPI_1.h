...
#define SPI_1_STATUS_PTR             ( (reg32 *) SPI_1_SCB__STATUS)
    ...
    #define SPI_1_UART_TX_CTRL_PTR       ( (reg32 *) SPI_1_SCB__UART_RX_CTRL)
...
#define SPI_1_EZBUF_DATA00_REG       (*(reg32 *) SPI_1_SCB__EZ_DATA00)
#define SPI_1_EZBUF_DATA00_PTR       ( (reg32 *) SPI_1_SCB__EZ_DATA00)
...
#if (SPI_1_CY_SCBIP_V0 || SPI_1_CY_SCBIP_V1)
    #define SPI_1_FF_DATA_NR_LOG2_PLUS1_MASK (0x0Fu) /* FF_DATA_NR_LOG2_PLUS1 = 4, MASK = 2^4 - 1 = 15 */
    #define SPI_1_FF_DATA_NR_LOG2_MASK       (0x07u) /* FF_DATA_NR_LOG2 = 3, MASK = 2^3 - 1 = 7 */
#else
    #define SPI_1_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* FF_DATA_NR_LOG2_PLUS1 = 5, MASK = 2^5 - 1 = 31 */
    #define SPI_1_FF_DATA_NR_LOG2_MASK       (0x0Fu) /* FF_DATA_NR_LOG2 = 4, MASK = 2^4 - 1 = 15 */
#endif /* (SPI_1_CY_SCBIP_V0 || SPI_1_CY_SCBIP_V1) */
...
#define SPI_1_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) 0x01u << \
    ...
    #define SPI_1_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << SPI_1_SPI_CTRL_SSEL_POLARITY0_POS)
    #define SPI_1_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << SPI_1_SPI_CTRL_SSEL_POLARITY1_POS)
    #define SPI_1_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << SPI_1_SPI_CTRL_SSEL_POLARITY2_POS)
    #define SPI_1_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << SPI_1_SPI_CTRL_SSEL_POLARITY3_POS)
...
#define SPI_1_FIFO_SIZE      (8u)   /* Size of TX or RX FIFO: defined by HW */
#define SPI_1_EZBUFFER_SIZE  (32u)  /* EZ Buffer size: defined by HW        */
...
/* Returns FIFO size depends on SPI_1_CTRL_BYTE_MODE bit */
