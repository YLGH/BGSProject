...
static void SPI_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        SPI_1_uart_rx_i2c_scl_spi_mosi_SetDriveMode((uint8) pinsDm[SPI_1_MOSI_SCL_RX_PIN_INDEX]);
        ...
        SPI_1_uart_tx_i2c_sda_spi_miso_SetDriveMode((uint8) pinsDm[SPI_1_MISO_SDA_TX_PIN_INDEX]);
        ...
        SPI_1_uart_cts_spi_sclk_SetDriveMode((uint8) pinsDm[SPI_1_SCLK_PIN_INDEX]);
        ...
        SPI_1_uart_rts_spi_ss0_SetDriveMode((uint8) pinsDm[SPI_1_SS0_PIN_INDEX]);
