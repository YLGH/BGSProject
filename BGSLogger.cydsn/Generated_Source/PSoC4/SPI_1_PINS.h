...
***************************************/
    ...
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_REG  \
                                                (*(reg32 *) SPI_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_PTR  \
                                                ( (reg32 *) SPI_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_MASK \
                                                (SPI_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_POS  \
                                                (SPI_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)

    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_REG    (*(reg32 *) \
                                                              SPI_1_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_PTR    ( (reg32 *) \
                                                              SPI_1_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)

    #define SPI_1_INTCFG_TYPE_MASK                  (0x03u)
    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS  (SPI_1_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
...
#if(SPI_1_MOSI_SCL_RX_PIN)
    #define SPI_1_MOSI_SCL_RX_HSIOM_REG      (*(reg32 *) SPI_1_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define SPI_1_MOSI_SCL_RX_HSIOM_PTR      ( (reg32 *) SPI_1_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define SPI_1_MOSI_SCL_RX_HSIOM_MASK     (SPI_1_uart_rx_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define SPI_1_MOSI_SCL_RX_HSIOM_POS      (SPI_1_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
#endif /* (SPI_1_MOSI_SCL_RX_PIN) */

#if(SPI_1_MISO_SDA_TX_PIN)
    #define SPI_1_MISO_SDA_TX_HSIOM_REG      (*(reg32 *) SPI_1_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define SPI_1_MISO_SDA_TX_HSIOM_PTR      ( (reg32 *) SPI_1_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define SPI_1_MISO_SDA_TX_HSIOM_MASK     (SPI_1_uart_tx_i2c_sda_spi_miso__0__HSIOM_MASK)
    #define SPI_1_MISO_SDA_TX_HSIOM_POS      (SPI_1_uart_tx_i2c_sda_spi_miso__0__HSIOM_SHIFT)
#endif /* (SPI_1_MISO_SDA_TX_PIN_PIN) */

#if(SPI_1_SCLK_PIN)
    #define SPI_1_SCLK_HSIOM_REG     (*(reg32 *) SPI_1_uart_cts_spi_sclk__0__HSIOM)
    #define SPI_1_SCLK_HSIOM_PTR     ( (reg32 *) SPI_1_uart_cts_spi_sclk__0__HSIOM)
    #define SPI_1_SCLK_HSIOM_MASK    (SPI_1_uart_cts_spi_sclk__0__HSIOM_MASK)
    #define SPI_1_SCLK_HSIOM_POS     (SPI_1_uart_cts_spi_sclk__0__HSIOM_SHIFT)
#endif /* (SPI_1_SCLK_PIN) */

#if(SPI_1_SS0_PIN)
    #define SPI_1_SS0_HSIOM_REG      (*(reg32 *) SPI_1_uart_rts_spi_ss0__0__HSIOM)
    #define SPI_1_SS0_HSIOM_PTR      ( (reg32 *) SPI_1_uart_rts_spi_ss0__0__HSIOM)
    #define SPI_1_SS0_HSIOM_MASK     (SPI_1_uart_rts_spi_ss0__0__HSIOM_MASK)
    #define SPI_1_SS0_HSIOM_POS      (SPI_1_uart_rts_spi_ss0__0__HSIOM_SHIFT)
#endif /* (SPI_1_SS1_PIN) */
