...
uint32 RTC_1_GetDate(void)
{
    ...
    *                                               register.
    *
    *       RTC_1_ALARM_MIN_MASK       - The minute alarm mask allows 
    ...
    *
    *       RTC_1_ALARM_MONTH_MASK    - The month alarm mask allows
    *                                              matching the alarm month register 
    *                                              with the current month register.
    *
    *       RTC_1_ALARM_YEAR_MASK      - The year alarm mask allows
    ...
    *                                           the week register.
    *
    *  RTC_1_ALARM_DAYOFMONTH_MASK - The day of the month alarm mask allows
...
*   
*  RTC_1_STATUS_LY    - Status of Leap Year. This bit goes high
*                                  when the current year is a leap year.
*   
*  RTC_1_STATUS_AM_PM - Status of Current Time. This bit is low
...
uint32 RTC_1_RelativeToFixed(uint32 dayOfWeek, uint32 weekOfMonth, uint32 month, uint32 year)
{
    ...
    if((uint32)RTC_1_LAST != weekOfMonth)
    {
