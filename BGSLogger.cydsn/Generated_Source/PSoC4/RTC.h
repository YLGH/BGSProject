...
#define RTC_INITIAL_SECOND          (47u)
#define RTC_INITIAL_MINUTE          (0u)
#define RTC_INITIAL_HOUR            (12u)
#define RTC_INITIAL_DAY             (14u)
#define RTC_INITIAL_MONTH           (7u)
#define RTC_INITIAL_YEAR            (2015u)
...
#define RTC_INITIAL_DST_START_WOM   (5uL)
...
#define RTC_INITIAL_DST_STOP_WOM    (5uL)
...
static uint32 RTC_SetSecond(uint32 inputTime, uint32 second);
...
*
*******************************************************************************/
static CY_INLINE uint32 RTC_SetSecond(uint32 inputTime, uint32 second)
{
    inputTime &= ~(RTC_SECONDS_FULL_MASK);
    
    inputTime |= (second / 10u) << RTC_10_SECONDS_OFFSET;
    inputTime |= (second % 10u) << RTC_SECONDS_OFFSET;
    ...
    */
    ...
    return(retVal);
        ...
        *******************************************************************************/
        ...
        {
            (void)CySysWdtSetIsrCallback(wdtNumber, 0uL, RTC_Update);
        }
        ...
        *******************************************************************************/
        ...
        {
            (void)CySysWdtSetIsrCallback(wdtNumber, 0uL, (void *)0);
        }
